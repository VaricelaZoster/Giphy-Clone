  ...
  return (
    <div className='flex relative'>
        ...
        {query && (
            <button
                onClick={() => setQuery("")}
                className='absolute bg-gray-300 opacity-90 rounded-full right-20 mr-2 top-6 hover:darker1'>
                    <HiMiniXMark size={22}/>
                </button>
        )}

        <button onClick={searchGIFs}
         className='bg-gradient-to-tr from-pink-600 to-pink-400 hover:gradient2 text-white px-4 py-2 rounded-tr rounded-br '>
